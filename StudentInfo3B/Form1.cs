...
namespace StudentInfo3B
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            this.termsDropDownList.DataSource = school.Terms;
            Term  spr2020 = school.FindTerm(2020, TermsEnum.Spr);
            ...
            section2750.Assignments = this.dbContext.Assignments.Where(a =>
                a.Section.Id == comc2750.Id).ToList();
        ...
        private void sectionsDropDownList_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            {
                selectedSection.Enrollments = this.dbContext.Enrollments.Where(enr =>
